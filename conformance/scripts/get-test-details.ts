 ...
 *
 * Usage:
 *   npx tsx conformance/scripts/get-test-details.ts --plan <planId>
 *   npx tsx conformance/scripts/get-test-details.ts --module <moduleId>
 *   npx tsx conformance/scripts/get-test-details.ts --plan <planId> --failed-only
 */
  ...
  for (let i = 0; i < args.length; i++) {
    switch (args[i]) {
      ...
      case '-h':
        console.log(`
Usage:
  npx tsx conformance/scripts/get-test-details.ts [options]
...
Examples:
  npx tsx conformance/scripts/get-test-details.ts --plan aa4Qs25G69eya --failed-only
  npx tsx conformance/scripts/get-test-details.ts --module dgCRndFKYUThVZf --verbose
`);
        process.exit(0);
    }
  }
