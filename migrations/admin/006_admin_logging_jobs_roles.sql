-- =============================================================================
-- Authrim Admin Baseline: Logging Jobs and Role Canonicalization
-- Consolidated for fresh Authrim installs from admin/027_logging_message_jobs.sql, admin/028_admin_system_role_canonicalization.sql.
-- =============================================================================

-- -----------------------------------------------------------------------------
-- Source: admin/027_logging_message_jobs.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Source: admin/028_admin_system_role_canonicalization.sql
-- -----------------------------------------------------------------------------
