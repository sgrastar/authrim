-- =============================================================================
-- Authrim Admin Migration 008: Persistent Identifier Profiles
-- Consolidated for fresh Authrim installs from migrations/admin/012_persistent_identifier_profiles.sql.
-- =============================================================================

-- -----------------------------------------------------------------------------
-- Source: migrations/admin/012_persistent_identifier_profiles.sql
-- -----------------------------------------------------------------------------
