-- =============================================================================
-- Authrim External Postgres Migration 006: Flow Runtime
-- Consolidated for fresh Authrim installs from migrations/external/postgres/008_external_flow_runtime_contract.sql, migrations/external/postgres/009_external_flow_interaction_context.sql, migrations/external/postgres/013_external_flow_template_id.sql, migrations/external/postgres/015_external_unique_flow_assignments.sql.
-- =============================================================================

-- -----------------------------------------------------------------------------
-- Source: migrations/external/postgres/008_external_flow_runtime_contract.sql
-- -----------------------------------------------------------------------------
...
CREATE INDEX IF NOT EXISTS idx_flow_interactions_state_updated
...
-- -----------------------------------------------------------------------------
-- Source: migrations/external/postgres/009_external_flow_interaction_context.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Source: migrations/external/postgres/013_external_flow_template_id.sql
-- -----------------------------------------------------------------------------
...
ALTER TABLE flows ADD COLUMN IF NOT EXISTS template_id TEXT;
...
-- -----------------------------------------------------------------------------
-- Source: migrations/external/postgres/015_external_unique_flow_assignments.sql
-- -----------------------------------------------------------------------------
