-- External durable schema for Consent records, Form profiles, and OIDC Scope master.
...
VALUES
  (
    ...
    'registration',
    '[{"field":"auth.passkey","label":"Create Account with Passkey","required":false,"block_type":"auth_widget","auth_method":"passkey","order":10},{"field":"email","label":"Email","required":true,"block_type":"identity_field","order":20},{"field":"name","label":"Name","required":false,"block_type":"identity_field","order":30}]'::jsonb,
    NULL,
    TRUE,
    TRUE,
    0,
  ...
  (
    ...
    'login',
    '[{"field":"email","label":"Email","required":false}]'::jsonb,
    NULL,
    TRUE,
    TRUE,
    0,
