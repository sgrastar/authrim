const adminScimTokens = {
	...
	admin_scim_tokens_inbound_title: 'Inbound provisioning',
	admin_scim_tokens_settings_load_failed: 'Failed to load SCIM settings',
	admin_scim_tokens_settings_save_failed: 'Failed to save SCIM settings',
	admin_scim_tokens_settings_saved: 'SCIM inbound settings saved.',
	admin_scim_tokens_settings_loading: 'Loading SCIM settings...',
	admin_scim_tokens_inbound_enabled: 'Enable inbound SCIM provisioning',
	admin_scim_tokens_mapping_set: 'Inbound Mapping Set',
	admin_scim_tokens_mapping_set_placeholder: 'Select an active Mapping Set',
	...
	admin_scim_tokens_bulk_max_operations: 'Bulk max operations',
	admin_scim_tokens_bulk_max_payload: 'Bulk max payload (bytes)',
	admin_scim_tokens_settings_saving: 'Saving...',
	admin_scim_tokens_settings_save: 'Save inbound settings',
