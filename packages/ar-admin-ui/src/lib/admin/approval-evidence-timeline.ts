...
export function getApprovalEvidenceArtifactSwitch(
	event: ApprovalTransportEvidenceEvent
): {
...
export function getApprovalEvidenceCompletionArtifact(
	event: ApprovalTransportEvidenceEvent
): {
...
export function getApprovalEvidenceDecisionReceipt(
	event: ApprovalTransportEvidenceEvent
): {
...
export function getApprovalEvidenceGrantSubjectTokenIssue(
	event: ApprovalTransportEvidenceEvent
): {
	grantId: string | null
	...
	const expiresIn = typeof issue.expires_in === 'number' && Number.isFinite(issue.expires_in)
		? issue.expires_in
		: null
