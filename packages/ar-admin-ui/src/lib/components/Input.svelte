...
<style>
	...
	.form-input:focus {
		...
		box-shadow: var(--control-focus-shadow, 0 0 0 4px var(--color-accent-muted));
	}
	...
	.form-input.has-error:focus {
		box-shadow: var(
			--control-error-focus-shadow,
			0 0 0 4px color-mix(in srgb, var(--color-danger) 14%, transparent)
		);
	}
