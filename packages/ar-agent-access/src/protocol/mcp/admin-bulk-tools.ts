...
export const ADMIN_BULK_TOOL_DEFINITIONS: readonly AgentToolDefinition[] = sealAgentToolDefinitions(
  [
    {
    ...
    },
    {
      ...
      inputSchema: PLAN_REF,
      outputSchema: objectSchema(
        { bulk_plan_id: ID, version: VERSION, status: { const: 'ready' } },
        ['bulk_plan_id', 'version', 'status']
      ),
      annotations: WRITE,
      taskSupport: 'forbidden',
      executionTarget: 'bulk_plan',
