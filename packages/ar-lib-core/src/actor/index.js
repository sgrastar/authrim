 ...
 * @example
 * ```typescript
 * import { ActorContext, ActorStorage } from '@authrim/ar-lib-core/actor';
 * import { CloudflareActorContext } from '@authrim/ar-lib-core/actor/adapters/cloudflare-actor-adapter';
 *
