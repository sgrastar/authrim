 ...
 */
export function sanitizeEventDetails(details, tenantPiiConfig) {
 ...
 */
export async function writeEventDetails(details, r2Bucket, tenantId, entryId) {
 ...
 */
export async function readEventDetails(detailsJson, detailsR2Key, r2Bucket) {
    // Inline details
    if (detailsJson) {
        try {
 ...
 */
export async function writePIIValues(encryptedJson, r2Bucket, tenantId, entryId) {
    // IMPORTANT: Use byte length, not string length (Unicode safety)
 ...
 */
export function generateAAD(tenantId, affectedFields) {
 ...
 */
export function calculateRetentionUntil(retentionDays, fromDate = new Date()) {
 ...
 */
export async function decryptPIIValues(encrypted, tenantId, affectedFields, keyProvider) {
 ...
 */
export async function readAndDecryptPIIValues(valuesEncrypted, valuesR2Key, r2Bucket, tenantId, affectedFields, keyProvider) {
 ...
 * ```
 */
export function logAuditAsync(ctx, auditService, tenantId, params, logger) {
    ctx.waitUntil(auditService.logEvent(tenantId, params).catch((error) => {
