...
export const BUILTIN_RUNTIME_PROFILES = [
    {
        id: DEFAULT_STORAGE_PROFILE_ID,
        kind: 'storage',
        label: 'Standard D1 Split',
        description: 'Default D1 split for core user data, custom claims, and registration fields. PII data uses DB_PII.',
        builtin: true,
        version: 1,
    ...
    },
    {
        ...
        description: 'Fallback profile for lightweight installs. Users and custom fields stay in the primary database.',
        builtin: true,
        version: 1,
        residencyProfileId: DEFAULT_RESIDENCY_PROFILE_ID,
        slices: {
    ...
    },
    {
        ...
        kind: 'storage',
        label: 'EU PII Split',
        description: 'Keep core/auth data on the primary database while routing user and custom PII slices to the EU-oriented PII backend.',
        builtin: true,
        version: 1,
    ...
    },
    {
        ...
        description: 'Example external database profile for user, custom-claim, and PII slices via portable adapters.',
        builtin: true,
        version: 1,
        residencyProfileId: DEFAULT_RESIDENCY_PROFILE_ID,
        slices: {
    ...
    },
    {
        ...
        description: 'Primary searchable store with optional archive/sink expansion. Small installs can stay on D1.',
        builtin: true,
        version: 1,
    ...
    },
    {
        ...
        description: 'Archive-only audit profile for large-volume installs. No hot query store; archive to R2 and forward to Workers Logpush-compatible structured logs.',
        builtin: true,
        version: 1,
        primary: null,
        archive: { type: 'r2', bucketRef: 'DIAGNOSTIC_LOGS', prefix: 'audit/' },
