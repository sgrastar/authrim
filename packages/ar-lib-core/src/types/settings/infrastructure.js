 ...
 */
import { DEFAULT_AUDIT_PROFILE_ID, DEFAULT_RESIDENCY_PROFILE_ID, DEFAULT_STORAGE_PROFILE_ID, } from '../runtime-profile';
/**
 * Infrastructure Settings Metadata
 *
 * Note: Sharding settings are managed in the dedicated Sharding Configuration page.
 */
export const INFRASTRUCTURE_SETTINGS_META = {
    // Cache Configuration
    ...
    'infra.jwks_cache_ttl': {
        ...
        description: 'Cache TTL for platform signing keys JWKS endpoint in seconds (see external-idp.jwks_cache_ttl for external IdP keys)',
        min: 300,
        max: 604800,
        unit: 'seconds',
        visibility: 'admin',
 ...
 */
export const INFRASTRUCTURE_CATEGORY_META = {
