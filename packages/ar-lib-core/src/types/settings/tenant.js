 ...
 */
export const TENANT_SETTINGS_META = {
    // Core Settings
    'tenant.base_domain': {
    ...
    'tenant.user_id_format': {
        ...
        description: 'Format for generating user IDs. "nanoid" (default) generates URL-safe 21-character IDs. "uuid" generates standard UUID v4 format. This setting is configured during setup and cannot be changed after users are created.',
        enum: ['nanoid', 'uuid'],
        visibility: 'internal',
    },
    // CORS Settings
    'tenant.allowed_origins': {
        ...
        description: 'Comma-separated list of allowed origins for Direct Auth API. Supports wildcards (e.g., https://*.pages.dev). If not set, all origins are allowed without credentials.',
        visibility: 'admin',
    },
    'tenant.allowed_domains': {
        ...
        description: 'Comma-separated list of exact request hosts allowed for this tenant. Empty keeps the canonical issuer host only.',
        visibility: 'admin',
    },
    'tenant.allowed_identifiers': {
        ...
        description: 'Comma-separated list of exact issuer/verifier identifiers allowed for this tenant. Empty disables additional identifier restrictions.',
        visibility: 'admin',
    },
    'tenant.storage_profile_id': {
        ...
        description: 'Optional storage profile ID override for this tenant. Empty means inherit the environment default.',
        visibility: 'admin',
    },
    'tenant.audit_profile_id': {
        ...
        description: 'Optional audit profile ID override for this tenant. Empty means inherit the environment default.',
        visibility: 'admin',
    },
    'tenant.residency_profile_id': {
        ...
        description: 'Optional residency profile ID override for this tenant. Empty means inherit the environment default.',
        visibility: 'admin',
    },
    // Branding
    'tenant.name': {
 ...
 */
export const TENANT_CATEGORY_META = {
    category: 'tenant',
    label: 'Tenant',
