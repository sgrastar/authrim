...
const en = {
	...
	login_guestRetention:
		'Guest accounts are eligible for automatic deletion {days:number} days after creation. Register an account to keep using it.',
	login_guestNoExpiry: 'No automatic deletion is scheduled for new guest accounts.',
	...
	language_region_east_asia: 'East Asia',
	language_region_south_southeast_asia: 'South & Southeast Asia',
	language_region_europe: 'Europe',
	language_region_middle_east_north_africa: 'Middle East & North Africa',
	language_region_sub_saharan_africa: 'Sub-Saharan Africa',
	...
	account_launcherTitle: 'My applications',
	account_launcherDescription: 'Search and open the applications available to you.',
	account_launcherLoadFailed: 'Applications could not be loaded.',
	account_launcherEmpty: 'No applications are available.',
	account_launcherSearch: 'Search applications',
	account_launcherAllCategories: 'All categories',
	account_launcherFavorites: 'Favorites',
	account_launcherNoMatches: 'No applications match these filters.',
	account_launcherFavoriteAdd: 'Add to favorites',
	account_launcherFavoriteRemove: 'Remove from favorites',
	account_launcherFavoriteUpdateFailed: 'Could not update the favorite status. Please try again.',
	account_launcherLegacy: 'Legacy mode',
