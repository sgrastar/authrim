...
export async function getCanonicalTenantBaseUrlAsync(env: Env, tenantId: string): Promise<string> {
  return buildCanonicalTenantIssuerUrl(env, tenantId, buildIssuerUrl(env, tenantId));
}
