 ...
 *
 * Tests for the ar-policy REST API endpoints.
 */
...
describe('Policy Service API', () => {
  describe('GET /policy/health', () => {
    it('should return health status', async () => {
      const req = createRequest('/api/policy/health', { withAuth: false });
      const res = await app.fetch(req, mockEnv);

      expect(res.status).toBe(200);
      const body = await res.json();
      expect(body.status).toBe('ok');
      expect(body.service).toBe('ar-policy');
  ...
  describe('POST /policy/evaluate', () => {
    it('should return 401 without authorization', async () => {
      const req = createRequest('/api/policy/evaluate', {
        method: 'POST',
        body: {},
        withAuth: false,
      });
  ...
  describe('POST /policy/check-role', () => {
    it('should return 401 without authorization', async () => {
      const req = createRequest('/api/policy/check-role', {
        method: 'POST',
        body: {},
        withAuth: false,
      });
  ...
  describe('POST /policy/is-admin', () => {
    it('should return 401 without authorization', async () => {
      const req = createRequest('/api/policy/is-admin', {
        method: 'POST',
        body: {},
        withAuth: false,
      });
