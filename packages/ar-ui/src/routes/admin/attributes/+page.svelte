...
<svelte:head>
	<title>User Attributes - Admin Dashboard - Authrim</title>
</svelte:head>
	...
	<div class="page-header">
		<div>
			...
			<p class="page-description">
				Manage user attributes for Attribute-Based Access Control (ABAC).
			</p>
		</div>
		<div class="page-actions">
			<button class="btn btn-secondary" onclick={() => (showCleanupDialog = true)}>
