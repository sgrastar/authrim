 ...
 *
 * @see packages/shared/src/rebac/relation-parser.ts
 * @see packages/shared/src/rebac/types.ts
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';
import { RelationParser, createEvaluationContext, DEFAULT_MAX_DEPTH } from '@authrim/shared';
import type {
  DirectRelation,
  UnionRelation,
