...
export const SECRET_UPLOAD_PLAN: Record<WorkerComponent, readonly SecretName[]> = {
  ...
  'ar-agent-access': ['AGENT_ELEVATION_ENCRYPTION_KEY', 'CONTROL_SMOKE_VERIFYING_PUBLIC_JWKS'],
  'ar-router': [],
  'ar-async': ['OBJECT_ENCRYPTION_ROOT_KEY', 'CONTROL_SMOKE_VERIFYING_PUBLIC_JWKS'],
  'ar-policy': ['CONTROL_SMOKE_VERIFYING_PUBLIC_JWKS'],
  'ar-saml': [
    'TENANT_RUNTIME_REGISTRY_VERIFYING_PUBLIC_JWKS',
    'CONTROL_SMOKE_VERIFYING_PUBLIC_JWKS',
  ],
