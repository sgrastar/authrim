...
export const SECRET_UPLOAD_PLAN: Record<WorkerComponent, readonly SecretName[]> = {
  'ar-lib-core': ['OBJECT_ENCRYPTION_ROOT_KEY'],
  ...
  'ar-token': ['PUBLIC_JWK_JSON', 'TENANT_RUNTIME_REGISTRY_VERIFYING_PUBLIC_JWKS'],
  'ar-userinfo': [
    'PUBLIC_JWK_JSON',
    'TENANT_RUNTIME_REGISTRY_VERIFYING_PUBLIC_JWKS',
    'DOWNSTREAM_GRANT_INTROSPECTION_CLIENT_ID',
  ...
  'ar-policy': [],
  'ar-saml': ['TENANT_RUNTIME_REGISTRY_VERIFYING_PUBLIC_JWKS'],
  'ar-bridge': ['RP_TOKEN_ENCRYPTION_KEY', 'TENANT_RUNTIME_REGISTRY_VERIFYING_PUBLIC_JWKS'],
  'ar-vc': ['PUBLIC_JWK_JSON', 'TENANT_RUNTIME_REGISTRY_VERIFYING_PUBLIC_JWKS'],
};
