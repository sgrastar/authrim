...
export default defineConfig({
	...
	shortcuts: {
		...
		'btn-primary': 'btn-base bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-700 dark:bg-primary-600 dark:hover:bg-primary-700',
		'btn-secondary': 'btn-base bg-gray-200 text-gray-700 hover:bg-gray-300 focus:ring-gray-400 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 dark:focus:ring-gray-500',
		'btn-ghost': 'btn-base text-primary-600 hover:bg-primary-50 focus:ring-primary-700 dark:text-primary-400 dark:hover:bg-primary-900/20',
