...
Usage:
  pnpm exec tsx test/environment-validation/local-capacity.ts --env <env> --lps 100 --duration-seconds 30
  pnpm exec tsx test/environment-validation/local-capacity.ts --config <path/to/.authrim/{env}/config.json> --scenario protected-resource --lps 150
