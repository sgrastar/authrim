...
Usage:
  pnpm exec tsx test/environment-validation/smoke-generated-api.ts --env <env>
  pnpm exec tsx test/environment-validation/smoke-generated-api.ts --config <path/to/.authrim/{env}/config.json>
