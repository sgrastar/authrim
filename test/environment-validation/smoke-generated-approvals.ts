...
Usage:
  pnpm exec tsx test/environment-validation/smoke-generated-approvals.ts --env <env>
  pnpm exec tsx test/environment-validation/smoke-generated-approvals.ts --config <path/to/.authrim/{env}/config.json>
