...
Usage:
  pnpm exec tsx test/environment-validation/validate-generated-env.ts --env <env>
  pnpm exec tsx test/environment-validation/validate-generated-env.ts --config <path/to/.authrim/{env}/config.json>
