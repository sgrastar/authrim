...
These are operator-driven checks rather than local unit tests. The deployment workflow invokes the
non-destructive validation and smoke runners against its generated test environment; local use may
target any disposable generated environment.
...
```bash
pnpm exec tsx test/generated-environment/validate-generated-env.ts --env single
pnpm exec tsx test/generated-environment/validate-generated-env.ts --config /path/to/.authrim/single/config.json
pnpm exec tsx test/generated-environment/validate-generated-env.ts --env single --json
pnpm exec tsx test/generated-environment/validate-generated-env.ts --env single --live-cloudflare
```
...
```bash
pnpm exec tsx test/generated-environment/smoke-generated-api.ts --env single
pnpm exec tsx test/generated-environment/smoke-generated-api.ts --config /path/to/.authrim/single/config.json
```
...
```bash
pnpm exec tsx test/generated-environment/smoke-generated-admin-api.ts --env single
pnpm exec tsx test/generated-environment/smoke-generated-admin-api.ts --config /path/to/.authrim/single/config.json
```
...
```bash
pnpm exec tsx test/generated-environment/smoke-generated-auth-flow.ts --env single
pnpm exec tsx test/generated-environment/smoke-generated-auth-flow.ts --config /path/to/.authrim/single/config.json
```
...
```bash
pnpm exec tsx test/generated-environment/smoke-generated-approvals.ts --env single
pnpm exec tsx test/generated-environment/smoke-generated-approvals.ts --config /path/to/.authrim/single/config.json
```
...
```bash
pnpm exec tsx test/generated-environment/smoke-generated-server-surfaces.ts --env single
pnpm exec tsx test/generated-environment/smoke-generated-server-surfaces.ts --config /path/to/.authrim/single/config.json
```
...
pnpm exec tsx test/generated-environment/local-capacity.ts \
  --env single \
