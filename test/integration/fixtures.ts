...
import { generateSecureRandomString, generateCodeChallenge } from '../../packages/shared/src/utils/crypto';
...
export async function createMockEnv(): Promise<Env> {
  ...
  const { generateKeySet } = await import('../../packages/shared/src/utils/keys');
