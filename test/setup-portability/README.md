...
```bash
pnpm exec tsx test/setup-portability/smoke-generated-approvals.ts --env single
pnpm exec tsx test/setup-portability/smoke-generated-approvals.ts --config /path/to/.authrim/single/config.json
```
...
```bash
pnpm exec tsx test/setup-portability/smoke-generated-server-surfaces.ts --env single
pnpm exec tsx test/setup-portability/smoke-generated-server-surfaces.ts --config /path/to/.authrim/single/config.json
```
...
```bash
pnpm exec tsx test/setup-portability/load-generated-live-safe.ts --env single --profile safe
pnpm exec tsx test/setup-portability/load-generated-live-safe.ts --config /path/to/.authrim/single/config.json --profile medium --json
```
