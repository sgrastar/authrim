...
Usage:
  pnpm exec tsx test/setup-portability/smoke-generated-admin-api.ts --env <env>
  pnpm exec tsx test/setup-portability/smoke-generated-admin-api.ts --config <path/to/.authrim/{env}/config.json>
