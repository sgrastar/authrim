...
Usage:
  pnpm exec tsx test/setup-portability/smoke-generated-api.ts --env <env>
  pnpm exec tsx test/setup-portability/smoke-generated-api.ts --config <path/to/.authrim/{env}/config.json>
