...
Usage:
  pnpm exec tsx test/setup-portability/smoke-generated-auth-flow.ts --env <env>
  pnpm exec tsx test/setup-portability/smoke-generated-auth-flow.ts --config <path/to/.authrim/{env}/config.json>
