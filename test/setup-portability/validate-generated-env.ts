...
Usage:
  pnpm exec tsx test/setup-portability/validate-generated-env.ts --env <env>
  pnpm exec tsx test/setup-portability/validate-generated-env.ts --config <path/to/.authrim/{env}/config.json>
